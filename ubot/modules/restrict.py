...
from ubot.utils import get_seles
...
@ubot.on_message(anjay(["ban", "dban"]) & filters.me)
...
@ubot.on_message(anjay(["pin", "unpin"]) & filters.me)
...
@ubot.on_message(anjay(["kick", "dkick"]) & filters.me)
...
@ubot.on_message(
    filters.group & anjay(["promote", "fullpromote"]) & filters.me
)
