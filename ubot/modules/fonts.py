...
• Perintah: <code>{cobadah}font</code> [nama font] [balas ke pesan]
• Penjelasan: Untuk membuat kata dengan font.

• Perintah: <code>{cobadah}lf</code>
• Penjelasan: Untuk melihat daftar fonts.

Notes: Gunakan format <code>{cobadah}font</code> 1 [balas pesan].
...
@ubot.on_message(filters.me & anjay(["font"]))
...
@ubot.on_message(filters.me & anjay(["lf", "listfont"]))
